...
def whitelisted():
    async def predicate(ctx):
        whitelistedmembers = [163691476788838401, 173498062260404225, 186081930972889088, 265953808381640704, 174982651759820800, 201731484363522048, 439291697634213888]
